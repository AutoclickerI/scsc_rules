...
> 최신 개정일: 2026-03-25
>
> 최신 개정자: [박명석CSE](mailto:tomskang@naver.com)
>
...
### 세칙 C. 법인으로 보는 단체 SCSC

**제 1조(명칭)**  
① 본회에 소속하는 법인으로 보는 단체의 명칭은 `서울대 컴퓨터 연구회 SCSC`라 칭한다.  
② 법인으로 보는 단체 `서울대 컴퓨터 연구회 SCSC`(이하: 단체)의 국문표기는 다음으로 한다.

1. 국문표기: 서울대 컴퓨터 연구회  
2. 국문약칭: 비영리단체 SCSC  

③ 단체의 소재지는 총동아리연합회 회칙에 근거하여 배정받은 SCSC의 동아리방으로 한다.  

> 서울특별시 관악구 관악로 1, 63동(학생회관) 438호  

**제 2조(회원구성)**  
① 단체의 회원은 회장, 부회장 및 회계를 구성하는 것이 원칙이되 임원진의 의사에 따라 임의구성할 수 있다.  
② 단체의 대표는 임원진의 의사에 따라 선출한다.  
③ 단체의 회원구성은 다음과 같다.
